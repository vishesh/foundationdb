...
public:
	...
	bool FAILURE_MONITOR_PUBLISH_TO_CC_ENABLED;
	int FAILURE_MONITOR_PUBLISH_INTERVAL_SECS;
	int FAILURE_MONITOR_PUBLISH_REQUEST_TIMEOUT_SECS;
	int FAILURE_MONITOR_PUBLISH_RETRY_INTERVAL_SECS;
